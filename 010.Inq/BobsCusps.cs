    ...
    namespace BobsCusps {
        ...
        public class Cusps {
            ...
            public double     Straightness(int a, int b) {
                return V2D.Straightness(_cusps.pts, _cusps.cusps[a].index, _cusps.cusps[b].index);
            }
        ...
        public static class FeaturePointDetector {
            ...
            static int convertIndex(int ind, IEnumerable<int> skipped) {
                int toadd = 0;
            ...
            public static Rad CuspThreshold = 0.1275;
            ...
            public static CuspSet FeaturePoints(Stroq s) {
                ...
                if(s.Count < 5) {
                    ...
                    return new CuspSet(s, cusprecs, s, new double[s.Count], new Rad[s.Count], new Rad[s.Count], new int[] { }, new List<int>(), bbox, CuspThreshold, cuspIndexes, new int[0]);
                }
                ...
                IList<int> intersects = finalSelfInters.Select((si) => convertIndexBack((int)si, skipped)).ToArray();
