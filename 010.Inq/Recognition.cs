...
namespace starPadSDK.CharRecognizer {
    ...
    public class Recognition {
        ...
        public bool msftRecoged; // true if we couldn't recognize the allograph at all and are relying on the MSFT recognize
        ...
        private static void InitializeAllographAlternates() {
            ...
            InitialSetAlternates("^", '^', 'Λ', Unicode.L.LOGICAL_AND, Unicode.N.N_ARY_LOGICAL_AND);
            ...
            InitialSetAlternates("~", '~', Unicode.M.MINUS_SIGN, Unicode.T.TILDE_OPERATOR);
