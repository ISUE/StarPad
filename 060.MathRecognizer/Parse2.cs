...
namespace starPadSDK.MathRecognizer {
    public class Parse2 {
        ...
        private Parser.ParseResult _parseResult;
        public Parser.ParseResult ParseResult { get { return _parseResult; } }
        ...
        private Expr CloseOutNumeric(ref string numeric, List<Symbol> numericsyms) {
            ...
            else if(numeric.IndexOf('.') >= 0) e = new DoubleNumber(Double.Parse(numeric));
...
new Recognition(sks, Unicode.M.MINUS_SIGN.ToString(), sks.GetBoundingBox().Bottom, (sks.GetBoundingBox().Top+sks.GetBoundingBox().Bottom)/2, false));
        ...
        static private List<WKSID> _expfns = new List<WKSID>(new WKSID[]{ WKSID.acos, WKSID.acosh, WKSID.acot, WKSID.acoth, WKSID.acsc, WKSID.acsch,
            WKSID.asec, WKSID.asech, WKSID.asin, WKSID.asinh, WKSID.atan, WKSID.atanh, WKSID.cos, WKSID.cosh, WKSID.cot, WKSID.coth,
            WKSID.csc, WKSID.csch, WKSID.ln, WKSID.log, WKSID.sec, WKSID.sech, WKSID.sin, WKSID.sinh, WKSID.tan,
            WKSID.tanh });

        private static readonly WKSID[] _wkfns = new WKSID[] { WKSID.acos, WKSID.acosh, WKSID.acot, WKSID.acoth, WKSID.acsc, WKSID.acsch, WKSID.arg,
            WKSID.asec, WKSID.asech, WKSID.asin, WKSID.asinh, WKSID.atan, WKSID.atanh, WKSID.cos, WKSID.cosh, WKSID.cot, WKSID.coth,
            WKSID.csc, WKSID.csch, WKSID.im, WKSID.ln, WKSID.log, WKSID.mod, WKSID.re, WKSID.sec, WKSID.sech, WKSID.sin, WKSID.sinh, WKSID.tan,
            WKSID.tanh, WKSID.True, WKSID.False };
