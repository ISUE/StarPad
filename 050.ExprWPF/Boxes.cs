...
namespace starPadSDK.MathExpr.ExprWPF.Boxes {
    public abstract class Box {
        ...
        private Expr _expr; public Expr Expr { get { return _expr; } set { _expr = value; } } // TJC: allow override of box expr
    ...
    public class HBox : Multibox {
        ...
        public HBox Clone()
        {
            HBox clone = new HBox(this.Expr.Clone(), this.Boxes);
            clone._nombboxRefOrigin = this._nombboxRefOrigin;
            clone._nombbox = this._nombbox;
            clone._bbox = this._bbox;
            clone._bboxRefOrigin = this._bboxRefOrigin;
            return clone;
        }
    ...
    public class StringBox : Multibox {
        ...
        {
            StringBox clone = new StringBox(this.Expr.Clone(), this._s, this.Bold, this.Italic, this._TexType);
            clone._nombboxRefOrigin = this._nombboxRefOrigin;
            clone._nombbox = this._nombbox;
            clone._bbox = this._bbox;
            clone._bboxRefOrigin = this._bboxRefOrigin;
